...
static_assert(sizeof(APaperFlipbookActor) == 0x000248, "Wrong size on APaperFlipbookActor");
static_assert(offsetof(APaperFlipbookActor, RenderComponent) == 0x000240, "Member 'APaperFlipbookActor::RenderComponent' has a wrong offset!");
...
public:
	...
	float                                         PlayRate;                                          // 0x0420(0x0004)(Edit, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bLooping : 1;                                      // 0x0424(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bReversePlayback : 1;                              // 0x0424(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bPlaying : 1;                                      // 0x0424(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Net, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_425[0x3];                                      // 0x0425(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AccumulatedTime;                                   // 0x0428(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	UMulticastInlineDelegateProperty_             OnFinishedPlaying;                                 // 0x0448(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(APaperGroupedSpriteActor) == 0x000248, "Wrong size on APaperGroupedSpriteActor");
static_assert(offsetof(APaperGroupedSpriteActor, RenderComponent) == 0x000240, "Member 'APaperGroupedSpriteActor::RenderComponent' has a wrong offset!");
...
static_assert(sizeof(APaperSpriteActor) == 0x000248, "Wrong size on APaperSpriteActor");
static_assert(offsetof(APaperSpriteActor, RenderComponent) == 0x000240, "Member 'APaperSpriteActor::RenderComponent' has a wrong offset!");
...
static_assert(sizeof(APaperTerrainActor) == 0x000258, "Wrong size on APaperTerrainActor");
static_assert(offsetof(APaperTerrainActor, DummyRoot) == 0x000240, "Member 'APaperTerrainActor::DummyRoot' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, SplineComponent) == 0x000248, "Member 'APaperTerrainActor::SplineComponent' has a wrong offset!");
static_assert(offsetof(APaperTerrainActor, RenderComponent) == 0x000250, "Member 'APaperTerrainActor::RenderComponent' has a wrong offset!");
...
static_assert(sizeof(APaperTileMapActor) == 0x000248, "Wrong size on APaperTileMapActor");
static_assert(offsetof(APaperTileMapActor, RenderComponent) == 0x000240, "Member 'APaperTileMapActor::RenderComponent' has a wrong offset!");
