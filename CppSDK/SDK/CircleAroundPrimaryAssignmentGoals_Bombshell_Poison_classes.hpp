...
static_assert(sizeof(UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C) == 0x0000D8, "Wrong size on UCircleAroundPrimaryAssignmentGoals_Bombshell_Poison_C");
