...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    Param_bEnablePreviewDetailLevel                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Param_PreviewDetailLevel                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::SetPreviewDetailLevel(bool Param_bEnablePreviewDetailLevel, int32 Param_PreviewDetailLevel)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_bEnablePreviewDetailLevel = Param_bEnablePreviewDetailLevel;
	Parms.Param_PreviewDetailLevel = Param_PreviewDetailLevel;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    Param_bEnablePreviewLODDistance                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   Param_PreviewLODDistance                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::SetPreviewLODDistance(bool Param_bEnablePreviewLODDistance, float Param_PreviewLODDistance)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_bEnablePreviewLODDistance = Param_bEnablePreviewLODDistance;
	Parms.Param_PreviewLODDistance = Param_PreviewLODDistance;
