...
static_assert(sizeof(MissionObjectiveWidgetProviderInterface_C_GetObjectiveBulletIcon) == 0x000088, "Wrong size on MissionObjectiveWidgetProviderInterface_C_GetObjectiveBulletIcon");
