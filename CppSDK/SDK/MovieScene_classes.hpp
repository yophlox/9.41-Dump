...
public:
	...
	UMulticastInlineDelegateProperty_             OnPlay;                                            // 0x0370(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastInlineDelegateProperty_             OnPlayReverse;                                     // 0x0380(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastInlineDelegateProperty_             OnStop;                                            // 0x0390(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastInlineDelegateProperty_             OnPause;                                           // 0x03A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastInlineDelegateProperty_             OnFinished;                                        // 0x03B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x0007C8, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x000408, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000770, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000780, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
