...
static_assert(sizeof(UStructuralBuildingsInCachedPathOfPrimaryAssignments_C) == 0x0000D8, "Wrong size on UStructuralBuildingsInCachedPathOfPrimaryAssignments_C");
