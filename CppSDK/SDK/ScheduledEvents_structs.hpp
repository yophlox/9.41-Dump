...
static_assert(sizeof(FCalendarDownload) == 0x000068, "Wrong size on FCalendarDownload");
...
static_assert(offsetof(FCalendarDownload, CacheIntervalMins) == 0x000010, "Member 'FCalendarDownload::CacheIntervalMins' has a wrong offset!");
static_assert(offsetof(FCalendarDownload, Channels) == 0x000018, "Member 'FCalendarDownload::Channels' has a wrong offset!");
