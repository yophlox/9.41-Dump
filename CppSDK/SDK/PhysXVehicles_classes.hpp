...
public:
	...
	uint8                                         bDeprecatedSpringOffsetMode : 1;                   // 0x0168(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReverseAsBrake : 1;                               // 0x0168(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseRVOAvoidance : 1;                              // 0x0168(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRawHandbrakeInput : 1;                            // 0x0168(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearUpInput : 1;                               // 0x0168(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bRawGearDownInput : 1;                             // 0x0168(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         BitPad_68_6 : 2;                                   // 0x0068(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_169[0x3];                                      // 0x0169(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bWasAvoidanceUpdated : 1;                          // 0x016C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	...
	uint8                                         Pad_28C[0x24];                                     // 0x028C(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWheeledVehicleMovementComponent) == 0x0002B8, "Wrong size on UWheeledVehicleMovementComponent");
static_assert(offsetof(UWheeledVehicleMovementComponent, Mass) == 0x000170, "Member 'UWheeledVehicleMovementComponent::Mass' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, WheelSetups) == 0x000178, "Member 'UWheeledVehicleMovementComponent::WheelSetups' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragCoefficient) == 0x000188, "Member 'UWheeledVehicleMovementComponent::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisWidth) == 0x00018C, "Member 'UWheeledVehicleMovementComponent::ChassisWidth' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ChassisHeight) == 0x000190, "Member 'UWheeledVehicleMovementComponent::ChassisHeight' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DragArea) == 0x000194, "Member 'UWheeledVehicleMovementComponent::DragArea' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, EstimatedMaxEngineSpeed) == 0x000198, "Member 'UWheeledVehicleMovementComponent::EstimatedMaxEngineSpeed' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, MaxEngineRPM) == 0x00019C, "Member 'UWheeledVehicleMovementComponent::MaxEngineRPM' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, DebugDragMagnitude) == 0x0001A0, "Member 'UWheeledVehicleMovementComponent::DebugDragMagnitude' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, InertiaTensorScale) == 0x0001A4, "Member 'UWheeledVehicleMovementComponent::InertiaTensorScale' has a wrong offset!");
...
static_assert(offsetof(UWheeledVehicleMovementComponent, ReplicatedState) == 0x00022C, "Member 'UWheeledVehicleMovementComponent::ReplicatedState' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawSteeringInput) == 0x000244, "Member 'UWheeledVehicleMovementComponent::RawSteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawThrottleInput) == 0x000248, "Member 'UWheeledVehicleMovementComponent::RawThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, RawBrakeInput) == 0x00024C, "Member 'UWheeledVehicleMovementComponent::RawBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInput) == 0x000250, "Member 'UWheeledVehicleMovementComponent::SteeringInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInput) == 0x000254, "Member 'UWheeledVehicleMovementComponent::ThrottleInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInput) == 0x000258, "Member 'UWheeledVehicleMovementComponent::BrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInput) == 0x00025C, "Member 'UWheeledVehicleMovementComponent::HandbrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, IdleBrakeInput) == 0x000260, "Member 'UWheeledVehicleMovementComponent::IdleBrakeInput' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, StopThreshold) == 0x000264, "Member 'UWheeledVehicleMovementComponent::StopThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, WrongDirectionThreshold) == 0x000268, "Member 'UWheeledVehicleMovementComponent::WrongDirectionThreshold' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, ThrottleInputRate) == 0x00026C, "Member 'UWheeledVehicleMovementComponent::ThrottleInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, BrakeInputRate) == 0x000274, "Member 'UWheeledVehicleMovementComponent::BrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, HandbrakeInputRate) == 0x00027C, "Member 'UWheeledVehicleMovementComponent::HandbrakeInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, SteeringInputRate) == 0x000284, "Member 'UWheeledVehicleMovementComponent::SteeringInputRate' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent, OverrideController) == 0x0002B0, "Member 'UWheeledVehicleMovementComponent::OverrideController' has a wrong offset!");
...
static_assert(sizeof(USimpleWheeledVehicleMovementComponent) == 0x0002B8, "Wrong size on USimpleWheeledVehicleMovementComponent");
...
static_assert(sizeof(UVehicleAnimInstance) == 0x000970, "Wrong size on UVehicleAnimInstance");
static_assert(offsetof(UVehicleAnimInstance, WheeledVehicleMovementComponent) == 0x000960, "Member 'UVehicleAnimInstance::WheeledVehicleMovementComponent' has a wrong offset!");
...
static_assert(sizeof(AWheeledVehicle) == 0x0002B0, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x0002A0, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x0002A8, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
...
static_assert(sizeof(UWheeledVehicleMovementComponent4W) == 0x000430, "Wrong size on UWheeledVehicleMovementComponent4W");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, EngineSetup) == 0x0002B8, "Member 'UWheeledVehicleMovementComponent4W::EngineSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, DifferentialSetup) == 0x000358, "Member 'UWheeledVehicleMovementComponent4W::DifferentialSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, AckermannAccuracy) == 0x000374, "Member 'UWheeledVehicleMovementComponent4W::AckermannAccuracy' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, TransmissionSetup) == 0x000378, "Member 'UWheeledVehicleMovementComponent4W::TransmissionSetup' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, SteeringCurve) == 0x0003A8, "Member 'UWheeledVehicleMovementComponent4W::SteeringCurve' has a wrong offset!");
