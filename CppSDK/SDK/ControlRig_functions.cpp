...
void UControlRig::SetGlobalTransform(const class FName BoneName, const struct FTransform& InTransform)
{
...
struct FTransform UControlRig::GetGlobalTransform(const class FName BoneName) const
{
	static class UFunction* Func = nullptr;
