...
{
public:
	bool                                          ShowTestMesh_0;                                    // 0x0303(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(AS_Stream_2W_SBend_3L_a_C) == 0x000308, "Wrong size on AS_Stream_2W_SBend_3L_a_C");
static_assert(offsetof(AS_Stream_2W_SBend_3L_a_C, ShowTestMesh_0) == 0x000303, "Member 'AS_Stream_2W_SBend_3L_a_C::ShowTestMesh_0' has a wrong offset!");
